...
you can apply a colored background layer to a structured list.

<InlineNotification>

The experimental structured list with background applies to both the default and
selectable structured lists and is only available in the hang alignment.
