...
![Color of the for interactive structured list](images/structured-list-style-1.png)

</Tab>

<Tab label="Background">

![Color of the for interactive structured list](images/structured-list-style-2.png)
...
|                     | Row text          | `$focus`         | `$text-disabled`           |
|                     | Icon              | `$focus`         | `$icon-disabled`           |
...
![Spacing and measurements for Structured List](images/structured-list-style-5.png)
...
![Spacing and measurements for structured list with selection](images/structured-list-style-6.png)

</div>

<Caption>
  SSpacing and measurements for selectable structured list with hang alignment |
  px / rem
</Caption>
...
![Spacing and measurements for structured list with selection](images/structured-list-style-7.png)
